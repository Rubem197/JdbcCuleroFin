...
public class conectarBD {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //UPDATE Post SET updated_at = '2022-08-29' WHERE idUsuarios = 5
            updatear = sc.nextLine();
            upDelTabla(con, updatear);
    ...
    public static void upDelTabla(Connection con, String tabla) throws SQLException {
